...
def argsparser():
    ...
    parser.add_argument(
        "--threshold", type=float, default=0.4, help="Threshold of score.")
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output",
...
def multiclass_nms(bboxs, num_classes, match_threshold=0.4, match_metric='iou'):
    final_boxes = []
...
def nms(dets, match_threshold=0.3, match_metric='iou'):
