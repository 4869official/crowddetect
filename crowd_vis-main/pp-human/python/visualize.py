...
def visualize_box_mask(im, results, labels, threshold=0.4):
    """
    Args:
...
def draw_mask(im, np_boxes, np_masks, labels, threshold=0.4):
    """
    Args:
...
def draw_box(im, np_boxes, labels, threshold=0.4):
    """
    Args:
        im (PIL.Image.Image): PIL image
        np_boxes (np.ndarray): shape:[N,6], N: number of box,
