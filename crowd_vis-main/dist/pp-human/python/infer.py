...
from openvino_infer.openvino_id_cls_infer import id_cls_predictor
...
class Detector(object):
    ...
    def __init__(self,
        ...
        if run_mode =="openvino":
            self.predictor = id_cls_predictor(os.path.join(model_dir, "model.onnx"), core)
        else:
...
def visualize(image_list, result, labels, output_dir='output/', threshold=0.4):
